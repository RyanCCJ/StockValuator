...
function StockView({ data, t }: { data: FundamentalDataResponse; t: (key: string) => string }) {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle>{t("key_statistics")}</CardTitle>
                    <CardDescription>
            ...
            {data.analyst_rating && (
                <Card>
                    <CardHeader>
                        <CardTitle>{t("analyst_rating")}</CardTitle>
                    </CardHeader>
                    <CardContent>
            ...
            {data.institutional_holders && data.institutional_holders.length > 0 && (
                <Card>
                    <CardHeader>
                        <CardTitle>{t("institutional_holders")}</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
    ...
    return (
        <div className="space-y-6">
            ...
            {data.top_holdings && data.top_holdings.length > 0 && (
                <Card>
                    <CardHeader>
                        <CardTitle>{t("top_holdings")}</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <Table>
                            <TableHeader>
            ...
            {chartData.length > 0 && (
                <Card>
                    <CardHeader>
                        <CardTitle>{t("sector_weightings")}</CardTitle>
                    </CardHeader>
                    <CardContent>
